...
- **Provisioning Engine Obligation**
  For a given business application, [[Tables Overview#Relational Tables|define a relationship]] between a practice and a *provisioning engine*.

- **Human Obligation**
  For a given business application, [[Tables Overview#Relational Tables|define a relationship]] between a practice and a *user group*.
